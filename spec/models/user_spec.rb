...
describe User do
  ...
  describe "micropost associations" do
    ...
    describe "status" do
      ...
      it "should mot include unfollowed post" do
          expect(subject.feed).not_to include(unfollowed_post)
      end
      it {followed_user.microposts.each do |micropost|expect(subject.feed).to include(micropost) end}
    end
  end
  ...
  describe "following" do
    ...
    describe "followed user" do
      subject { other_user }
      it "followers should include user " do
